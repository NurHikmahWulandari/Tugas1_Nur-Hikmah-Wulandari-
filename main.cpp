/* MOHON MAAF PAK, TUGASNYA SAYA GABUNG 1X
KALAU MAU PERIKSA BISA GANTI <glutDisplayFunc(...)> baris 104 SESUAI NAMA VOID NYA (garis/titik/segi4)
KEMUDIAN HAPUS TAG KOMEN DI VOID YANG MAU DIPERIKSA
TERIMA KASIH PAK */
...
void garis(){
    ...
    glBegin(GL_LINES);                 //garis mulai
        glColor3f(0.4,0.3,0.1);        //Warna garis
